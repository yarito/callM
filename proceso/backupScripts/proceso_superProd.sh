...
#TENER EN CUENTA QUE SE LE DEBE SUMAR UN DIA AL CIERRE, PORQUE SE PROCESA LA MADRUGADA DEL DIA POSTERIOR
...
if [[ $dia -eq 27 && $mes -eq 4 && $anio -eq 18 && $flagDistribucion -eq 1 ]]
then
	echo 0 > $flagDistribucionArchivo
	actividadesCierre
fi
...
if [[ $dia -eq 29 && $mes -eq 7 && $anio -eq 18 && $flagDistribucion -eq 0 ]]
then
	echo 1 > $flagDistribucionArchivo
	actividadesCierre
...
#TENER EN CUENTA QUE SE LE DEBE SUMAR DOS DIAS AL DIA DE CIERRE, PORQUE SE PROCESA LA MADRUGADA DE DOS DIAS DESPUES
...
if [[ $dia -eq 28 && $mes -eq 4 && $anio -eq 18 ]]
then
	actividadesDeInicio 
fi
...
then
	...
	mandarMailDestinatarios "[CallMora]-Proceso%$mensaje%4%esteban.kutifak@fravega.com.ar%Portal.Novedades@fravega.com.ar%Oscar.Cohen@fravega.com.ar%Matias.Gentini@fravega.com.ar"
	...
	mandarMailDestinatarios "[CallMora]-Proceso%$errorMensaje%4%esteban.kutifak@fravega.com.ar%Portal.Novedades@fravega.com.ar%Oscar.Cohen@fravega.com.ar%Matias.Gentini@fravega.com.ar"
